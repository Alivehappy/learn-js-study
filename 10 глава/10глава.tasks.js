...
*/
/*Валидатор форм с кастомными ошибками"
Условие:
Создайте систему валидации с классами ошибок:

Реализуйте классы:

FormError (базовый)

RequiredFieldError (наследуется, код "FIELD_REQUIRED")

InvalidFormatError (наследуется, код "INVALID_FORMAT")
