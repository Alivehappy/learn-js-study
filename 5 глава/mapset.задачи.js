...
function countOccurrences(arr, element) {
  return arr.filter((item) => item === element).length; // Фильтруем массив, оставляем только те элементы, которые равны заданному, и считаем их количество
}

//Напишите функцию, которая принимает массив и число n, и возвращает массив массивов, где каждый подмассив содержит не более n элементов.
...
//   30: [{ name: "Bob", age: 30 }]
// }
//Напишите функцию, которая принимает два массива и возвращает новый массив, содержащий элементы, которые присутствуют в обоих массивах.
...
//Напишите функцию, которая принимает массив чисел и возвращает наибольшую сумму подмассива.
